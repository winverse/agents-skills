...
requireText("SKILL.md", "folder-local `AGENTS.md` indexes", "folder-local AGENTS sync rule");
requireText("SKILL.md", "table of contents", "folder index table of contents rule");
requireText("SKILL.md", "Target project skill setup", "target project setup sync rule");
...
requireText("references/doc-audit-checklist.md", "Folder AGENTS drift", "folder AGENTS drift taxonomy");
requireText("references/doc-audit-checklist.md", "Project setup drift", "project setup drift taxonomy");
...
requireText("skill.html", "folder-local AGENTS.md", "folder-local AGENTS visible guidance");
requireText("skill.html", "local map", "folder local map visible guidance");
requireText("skill.html", "validation commands", "folder validation command visible guidance");
