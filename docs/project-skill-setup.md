...
- `project-snippets/course-evaluator.md`: only student answer CSV, spreadsheet, assignment response, rubric-based grading, per-student Markdown output, individualized feedback, and repeated-comment verification.
