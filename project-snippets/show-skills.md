...
- Use $show-skills at <skills-root>/skills/show-skills/SKILL.md when asked to see, list, browse, summarize, choose, compare, or discover the current skills in this repository, or when asked which skill to use for a task.
